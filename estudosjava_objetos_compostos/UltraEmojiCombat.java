package estudosjava_objetos_compostos;

// objetos compostos - jogo de luta criado com prof.Guanabara
...
public class UltraEmojiCombat {
	...
	public static void main(String[] args) {
		...
		l[1] = new Lutador("Putscript", "Brasil", 29, 1.68f, 59.8f, 14, 2, 3);
		 ...
		 * l[3].apresentar(); System.out.println();
		 * System.out.println("**************"); l[3].status(); System.out.println();
		 * System.out.println("**************"); l[3].perderLuta();vai acrescentar 1 no
		 * "perdeu 0 vezes" l[3].status();
		 */
